...
const log = createLogger("api/seedream-4");
...
export async function POST(req: Request) {
    ...
    try {
        ...
        // 5. Generate with bytedance/seedream-4
        ...
        log.info({ batch, outputs: outfits.length, user_uuid }, "seedream-4 response ready");
        ...
        if (isSafetyError) {
            log.warn({ err: e, requestId }, "seedream-4 content flagged");
