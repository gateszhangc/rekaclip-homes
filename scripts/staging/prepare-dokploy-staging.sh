...
APPLICATION_NAME="${APPLICATION_NAME:-rekaclip-staging}"
APP_NAME="${APP_NAME:-$(slugify "$APPLICATION_NAME")}"
PRIMARY_URL="${PRIMARY_URL:-https://staging.rekaclip.homes}"
PRIMARY_DOMAIN="${PRIMARY_DOMAIN:-staging.rekaclip.homes}"
