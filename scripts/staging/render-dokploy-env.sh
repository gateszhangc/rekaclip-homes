...
STAGING_URL="${STAGING_URL:-https://staging.rekaclip.homes}"
STAGING_BACKEND_BASE_URL="${STAGING_BACKEND_BASE_URL:-http://144.91.64.239:5000}"
DEFAULT_STAGING_DATABASE_URL="${DEFAULT_STAGING_DATABASE_URL:-postgresql://rekaclip_staging_app:cee8f59fa94ee6462e5d8d785fa3147891520b5a28084be8@161.97.103.117:5432/rekaclip_staging?sslmode=require}"
OUTPUT_PATH="${1:-}"
